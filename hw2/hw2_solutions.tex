...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q3_cartpole_curve.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q3_cartpole_lb_curve.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q4_baseline_loss.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q4_avg_eval_return.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q5_avg_eval_return.png}
...
\begin{enumerate}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{q6_curves.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q7_avg_eval_return.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{q8_varience_curves.png}
    \caption{Learning curve for small batch cartpole experiments}
