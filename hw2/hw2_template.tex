...
\begin{itemize}
    \item Yes. Specifically, it accelerated convergence for all variants (trajectory centric v.s. reward-to-go, advantage normaliztion v.s. not) as evidenced by longer total training steps.
\end{itemize}
\end{itemize}
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Performance was even worse than the experiment without baseline.
