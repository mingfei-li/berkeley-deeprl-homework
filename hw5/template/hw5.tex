...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.32\textwidth]{PointmassEasy-v0_random.png}~
    \includegraphics[width=0.32\textwidth]{PointmassMedium-v0_random.png}~
    \includegraphics[width=0.32\textwidth]{PointmassHard-v0_random.png}~
    \vspace{-10pt}
    \caption{Figures depicting random exploration in \texttt{easy} (left), \texttt{medium} (middle) and \texttt{hard} (right) environments.}
    \vspace{-10pt}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.32\textwidth]{PointmassEasy-v0_rnd1.0.png}~
    \includegraphics[width=0.32\textwidth]{PointmassMedium-v0_rnd1.0.png}~
    \includegraphics[width=0.32\textwidth]{PointmassHard-v0_rnd1.0.png}~
    \vspace{-10pt}
    \caption{Figures depicting RND exploration in \texttt{easy} (left), \texttt{medium} (middle) and \texttt{hard} (right) environments.}
    \vspace{-10pt}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{4_1_q_values.png}
    \caption{Q-values for CQL with diffrent $\alpha$ values. As $alpha$ increases, the corresponding Q-value decreases, with the exception of $\alpha=10$ which has higher q-value than $\alpha=1$ and $\alpha=5$.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{4_1_eval_return.png}
    \caption{Eval returns for CQL with diffrent $\alpha$ values. An $\alpha=0.1$ achieves the best performance, whereas big $\alpha$ values like $5$ or $10$ significantly hurt performance.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{4_2_eval_return.png}
    \caption{Eval returns for medium environment with different methods. IQL eventually outperforms DQN/CQL whereas AWAC is very unstable.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{4_3_eval_return.png}
    \caption{Eval returns for hard environment with different sizes of datasets. With 20000 exploration steps, CQL acheives a peak return of -41.4 whereas few steps of exploration doesn't get CQL anywhere}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{5_eval_return.png}
    \caption{Eval returns for hard environment with different offline + finetune methods. CQL and AWAC achieve the highest returns with best stability, whereas IQL and DQN are much less stable.}
\end{figure}
